"""
Django settings for meetingsback project.
...
ROOT_URLCONF = 'meetingsback.urls'
...
WSGI_APPLICATION = 'meetingsback.wsgi.application'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'meeting'),
        'USER': os.getenv('DATABASE_USER', 'postgres'),
        'PASSWORD': os.getenv('DATABASE_PASSWORD', 'Msj.116159'),
